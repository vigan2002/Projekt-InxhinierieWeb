...
<section class="offer">
    ...
    <div class="content">
        <h3 class="vintage">About Us</h3>
        <h1 class="vintage">We are Worldwide Online Shop </h1>
        <p>We sell only vintage collectioble car posters, Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit, quis fugiat cumque officiis magni delectus tempora quod reprehenderit! Debitis, cumque nulla? Quibusdam dolore eos reprehenderit.</p>
