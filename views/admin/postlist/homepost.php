...
<div class="page-head">
	<table align="center" width="73%">
		<td><font class="title-head">Lista e Posteve</td>
	</table>
</div>
<br>
<br>
...
<table align="center" width="95%">
	<tr>
		<td>
			<h3 style="margin: 1px; margin-bottom: 6px;"><i class="fas fa-user-edit"></i>&nbsp;Lista e Posteve<i class="fas fa-angle-down"></i></h3>
			<div style="padding:2px;">
		<font>
			K&euml;tu mund&euml; t&euml; menagjoni postat, ku mund ti modifikoni ata!<br>
		</font>
	</div>
</tr>
</td>
...
<table width="100%" id="myTable" cellspacing="0" cellpadding="5" class="data_list">
            ...
            <?php if(empty($postat)){ echo '<tr><td colspan="16"><div style="text-align:center;"><strong>Nuk ka asnje post!!!!</strong></div></td></tr>'; }?>
